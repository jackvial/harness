...
void test('session status engine projects codex/claude/cursor telemetry into status model', () => {
  ...
  const codexActive = expectStatusModel(
    engine.project({
      agentType: 'codex',
  ...
  const codexResponseCompleted = expectStatusModel(
    engine.project({
      agentType: 'codex',
      runtimeStatus: 'running',
      attentionReason: null,
  ...
  const claudeStopped = expectStatusModel(
    engine.project({
      agentType: 'claude',
      runtimeStatus: 'running',
      attentionReason: null,
  ...
  const cursorWorking = expectStatusModel(
    engine.project({
      agentType: 'cursor',
      runtimeStatus: 'running',
      attentionReason: null,
...
void test('session status engine handles runtime-only branches for agent reducers', () => {
  ...
  const attentionRequired = expectStatusModel(
    engine.project({
      agentType: 'codex',
      runtimeStatus: 'running',
      attentionReason: null,
  ...
  const turnComplete = expectStatusModel(
    engine.project({
      agentType: 'codex',
      runtimeStatus: 'running',
      attentionReason: null,
  ...
  const completed = expectStatusModel(
    engine.project({
      agentType: 'codex',
  ...
  const exited = expectStatusModel(
    engine.project({
      agentType: 'codex',
...
void test('agent reducers are directly constructible and project telemetry consistently', () => {
  const codex = expectStatusModel(
    new CodexStatusReducer().project({
      runtimeStatus: 'running',
      attentionReason: null,
      telemetry: {
        source: 'otlp-log',
  ...
  const claude = expectStatusModel(
    new ClaudeStatusReducer().project({
      runtimeStatus: 'running',
      attentionReason: null,
      telemetry: {
        source: 'otlp-log',
  ...
  const cursor = expectStatusModel(
    new CursorStatusReducer().project({
      runtimeStatus: 'running',
      attentionReason: null,
      telemetry: {
        source: 'otlp-log',
...
void test('base reducer default projection covers idle and exited default detail text', () => {
  ...
  const completedIdleDefault = expectStatusModel(
    reducer.project({
      runtimeStatus: 'completed',
      attentionReason: null,
      telemetry: {
  ...
  const exitedDefault = expectStatusModel(
    reducer.project({
      runtimeStatus: 'exited',
      attentionReason: null,
      telemetry: null,
