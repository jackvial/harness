...
- Mux supports first-party in-pane selection with visual highlight and clipboard copy via `Alt+drag` in the left pane.
...
- Mux paint correctness:
  ...
  - hold `Alt` and drag in left pane to select and copy on mouse release (OSC52)
